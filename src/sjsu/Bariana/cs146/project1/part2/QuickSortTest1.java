...
public class QuickSortTest1 
{
   ...
   {              
	   ...
	   array1 = QS.quickSort2(array1, 0, array1.length - 1);  
	   assertArrayEquals(array1,array2);    
   	}  
   ...
   {       
	   ...
	   // sort using Java's inbuilt sorting method
        ...
        // run quickSort2()     
        array1 = QS.quickSort2(array2, 0, array2.length - 1);   
        assertArrayEquals(array1,array3);        
   }   
   ...
   {     
      ...
      start = System.currentTimeMillis();  
      array2 = QS.quickSort2(array2, 0, array2.length - 1);  
      end = System.currentTimeMillis();    
      elapsed = end - start;    
      System.out.println("quickSort2 time to sort 1000000 elements in ms:"+ elapsed);        
      start = System.currentTimeMillis(); 
      array3 = QS.quickSort2(array3, 0, array3.length - 1);   
      end = System.currentTimeMillis();     
      elapsed = end - start;     
